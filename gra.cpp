...
namespace gra{
	...
	void gl_draw_polygon(const int n, const point* points, const color col){
		//opengl绘制凸多边形
		glBegin(GL_POLYGON);
			glColor3f(col.r, col.g, col.b);
			for(int i = 0; i < n; i++){
	...
	void draw_line(pys::point A, pys::point B, color col = WHITE){
		//绘制线
